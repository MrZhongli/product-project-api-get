...
SCHEMA_PATH = Path('C:/Users/El pepe/Documents/pasantias-2025/product-project/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\El pepe\\.cache\\prisma-python\\binaries\\5.4.2\\ac9d7041ed77bcc8a8dbd2ab6616b39013829574\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    producto: 'actions.ProductoActions[models.Producto]'
    ...
    def __init__(
        ...
        *,
        ...
        self.producto = actions.ProductoActions[models.Producto](self, models.Producto)
    ...
    def _default_datasource(self) -> DatasourceOverride:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': 'mysql://flutterdb:123456@localhost:3306/flutterdb', 'fromEnvVar': None}).resolve(),
        }
...
class Batch:
    producto: 'ProductoBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.producto = ProductoBatchActions(self)
