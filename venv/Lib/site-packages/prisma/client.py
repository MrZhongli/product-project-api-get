...
class Prisma:
    raza: 'actions.RazaActions[models.Raza]'
    animal: 'actions.AnimalActions[models.Animal]'
    ...
    def __init__(
        ...
        *,
        ...
        self.raza = actions.RazaActions[models.Raza](self, models.Raza)
        self.animal = actions.AnimalActions[models.Animal](self, models.Animal)
...
class Batch:
    raza: 'RazaBatchActions'
    animal: 'AnimalBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.raza = RazaBatchActions(self)
        self.animal = AnimalBatchActions(self)
